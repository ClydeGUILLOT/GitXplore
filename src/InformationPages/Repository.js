                ...
                {isLoading ? <ActivityIndicator/> : (
                    <View>
                        <View style={{alignItems: "center"}}>
                            <View>
                                <Text style={{fontSize: 23, fontWeight: "bold", color: "white", padding: 15}}>{repoInfo.name}</Text>
                                <View style={{flexDirection: 'row', padding: 15}}>
                                    <View style={{flexDirection: 'row'}}>
                                        <Icon
                                            name="person"
                                            color={repoInfo.private === "true" ? "red" : "springgreen"}
                                        />
                                        <Text style={{fontSize: 18, fontStyle: "italic", color: "white"}}>{"\t"}{repoInfo.private === "true" ? "Private" : "Public"}</Text>
                                    </View>
                                    <View style={{flexDirection: 'row', paddingLeft: 20}}>
                                        ...
                                        />
                                        <Text style={{fontSize: 18, fontStyle: "italic", color: "white"}}>{"\t"}{repoInfo.fork === "true" ? "Fork" : "Not fork"}</Text>
                                    </View>
                                </View>
                            </View>
                            <Text style={{fontSize: 15, fontStyle: repoInfo.description !== null ? "normal" : "italic", color: "white", padding: 15}}>{repoInfo.description !== null ? `"${repoInfo.description}"` : "No description"}</Text>
                            <View style={{flexDirection: 'row', padding: 15}}>
                                <View style={{flexDirection: 'row', padding: 15}}>
                                    <Icon
                                        name="source"
                                        color="orange"
                                    />
                                    <Text style={{fontSize: 17, color: "white"}}>{"\t"}{repoInfo.size} kb</Text>
                                </View>
                                <View style={{flexDirection: 'row', paddingLeft: 20, padding: 15}}>
                                    <Icon
                                        name="mediation"
                                        color="orange"
                                    />
                                    <Text style={{fontSize: 17, color: "white"}}>{"\t"}{repoInfo.default_branch}</Text>
                                </View>
                            </View>
                        </View>
                            ...
                            <View style={{flex: 1, alignItems: "center"}}>
                                <View style={{flexDirection: 'row', padding: 10, }}>
                                    <Icon
                                        ...
                                        color="cyan"
                                    />
                                    <Text style={{color: "white", fontSize: 16}}>{"\t"}Contributors :</Text>
                                </View>
                                <FlatList
                            ...
                            <View style={{flex: 1, alignItems: "center"}}>
                                <View style={{flexDirection: 'row', padding: 10, }}>
                                    <Icon
                                        ...
                                        color="magenta"
                                    />
                                    <Text style={{color: "white", fontSize: 16}}>{"\t"}Issues :</Text>
                                </View>
                                <FlatList
